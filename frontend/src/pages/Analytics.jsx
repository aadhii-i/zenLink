...
export default function Analytics() {
  ...
  const totalClicks = useCountUp(report ? report.total_clicks : 0)
            ...
            <Card className="overflow-hidden">
              ...
              <table className="w-full text-sm mt-2">
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  {topUrls.map((topUrl) => (
                    <tr key={topUrl.id} className="transition-colors hover:bg-gray-50/80 dark:hover:bg-gray-800/40">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    {report.recent_clicks.map((click, index) => (
                      <tr key={index} className="transition-colors hover:bg-gray-50/80 dark:hover:bg-gray-800/40">
